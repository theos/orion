...
void _logos_with_objc_super(id receiver, Class cls, void(^block)(void *super_struct, void *send)) {
...
void _logos_with_objc_super_stret(id receiver, Class cls, void(^block)(void *super_struct, void *send)) {
    struct objc_super sup = { receiver, cls };
